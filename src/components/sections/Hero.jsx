...
const Hero = () => {
    ...
    return (
        <section id='hero' className='relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-dark-900 via-dark-800 to-dark-900 pt-24 pb-10 sm:pt-28 sm:pb-12'>
